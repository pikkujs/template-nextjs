...
// Type exports
export type RequiredSingletonServices = Pick<SingletonServices, 'config' | 'jwt' | 'logger' | 'schema' | 'secrets' | 'todoStore' | 'variables'> & Partial<Omit<SingletonServices, 'config' | 'jwt' | 'logger' | 'schema' | 'secrets' | 'todoStore' | 'variables'>>
