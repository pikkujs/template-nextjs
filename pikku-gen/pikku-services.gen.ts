...
// Type exports
export type RequiredSingletonServices = Pick<SingletonServices, 'config' | 'eventHub' | 'logger' | 'schema' | 'secrets' | 'todoStore' | 'variables'> & Partial<Omit<SingletonServices, 'config' | 'eventHub' | 'logger' | 'schema' | 'secrets' | 'todoStore' | 'variables'>>
